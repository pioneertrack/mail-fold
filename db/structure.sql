...
CREATE INDEX index_comments_on_votes_count ON public.comments USING btree (votes_count);
...
CREATE INDEX index_posts_on_votes_count ON public.posts USING btree (votes_count);
...
CREATE UNIQUE INDEX index_votes_on_votable_id_and_votable_type_and_user_id ON public.votes USING btree (votable_id, votable_type, user_id);
